...
namespace AZStackAuthenURLSapmle
{
...
IoIt4q2hgSWIvmnrtcgcbA==";
            ...
            if (plaintextToken.Length > 0)
            {
                ...
                if (plaintextJson != null)
                {
                    ...
                    string azStackUserID = (string)plaintextJson["azStackUserID"];
                    ...
                    if (code2.Equals(code))
                    {
                        ...
                        bool userCredentialsValid = true; //you can validate $azStackUserID and $userCredentials in your Database, etc
